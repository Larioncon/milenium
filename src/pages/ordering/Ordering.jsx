...
import novaPost from "./../../images/nova-post.png"
            ...
            <div className="ordering__wrapper">
                    ...
                    <div className="ordering__form-select">
                        <label className="ordering__select-label">
                            ...
                            <select name="" id="" className="ordering__select">
                                ...
                                <option className="ordering__option" value="">Румыния</option>
                                <option className="ordering__option" value="">Казахстан</option>
                            </select>
                        </label>
                        <label className="ordering__select-label">
                            Выберите город
                            <select name="" id="" className="ordering__select">
                                ...
                                <option className="ordering__option" value="">г Бухарест</option>
                                <option className="ordering__option" value="">г Астана</option>
                            </select>
                        </label>
                    </div>
                ...
                <div className="ordering__delivery">
                    <button
                        ...
                        <img className="ordering__delivery-img" src={novaPost} alt="" />
                    ...
                    <button
                        ...
                        <img className="ordering__delivery-img" src={novaPost} alt="" />
                        <div className="ordering__delivery-info">
                            <h3 className="ordering__delivery-title">НоваПошта</h3>
